...
while True:
   ...
   # DRAWING LINE OVER OBJECTS
    ...
    img_x,img_y = imp()
    if start==True:
        if (ang_car_imgp()<175 or ang_car_imgp()>185) and s1==False:
            command = 'R'
            s2=True
            s3=True
            s4=True
            ...
            s3=True
            s4=True
        if dis_ball_imp()>10 and s2==False:
            command ='F'
            s3=True
            s4=True
        else:
            ...
            s3=False
            s4=True
        if (ang_car_goal()<175 or ang_car_goal()>185) or s3==False:
            command = 'L'
            s4=True
        else:
            s3=True
            s4=False
        if dis_car_goal()>10 and s4==False:
            command = 'F'
        else:
            s4=True
            print("goal")
